...
$array = array (
  'form_name' => '',
  'welcome' => '<h3 class="static_header" style="text-align:left;">Contact</h3>
<p>Get in touch with any project ideas</p>',
  'email_to' => 'Webmaster,contact@stevenlitton.com',
  'php_mailer_enable' => 'phpmailer',
  'email_from' => 'contact@stevenlitton.com',
  'email_from_enforced' => 'true',
  'email_bcc' => '',
  'email_reply_to' => 'contact@stevenlitton.com',
  'email_subject' => 'stevenlitton.com Contact:',
  'email_subject_list' => '',
  'name_format' => 'name',
  'name_type' => 'required',
  'email_type' => 'required',
  ...
  'smtp_user' => 'contact@stevenlitton.com',
  'smtp_pass' => 'bourneFX09',
  ...
  'redirect_seconds' => '3',
  'redirect_url' => 'http://www.stevenlitton.com/',
  ...
  'auto_respond_from_name' => 'stevenlitton.com',
  'auto_respond_from_email' => 'stevelitton@gmail.com',
  'auto_respond_reply_to' => 'stevelitton@gmail.com',
  ...
  'required_style' => 'text-align:left; color:#FFF; padding-top:10px; border-radius:5px; -webkit-border-radius:5px; -o-border-radius:5px; -moz-border-radius:5px;',
  'notes_style' => 'text-align:left; border-radius:5px;',
  'title_style' => 'text-align:left; padding-top:5px; color:#FFF;',
  'select_style' => 'text-align:left;',
  'field_style' => 'text-align:left; margin:0; border-radius:5px; -webkit-border-radius:5px; -o-border-radius:5px; -moz-border-radius:5px;',
  'field_div_style' => 'text-align:left; margin-bottom:10px; border-radius:5px; -webkit-border-radius:5px; -o-border-radius:5px; -moz-border-radius:5px;',
  ...
  'captcha_input_style' => 'text-align:left; margin:0; width:50px; border-radius:5px; -webkit-border-radius:5px; -o-border-radius:5px; -moz-border-radius:5px;',
